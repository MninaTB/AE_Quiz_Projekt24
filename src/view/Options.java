...
/**
 * 
 * Options ist ein view, welches JComponents
 * haelt und anbietet.
 */
public class Options {
	...
	private void initComponents() {
		...
		this.centerScrollPane = new JScrollPane(centerPanel, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
