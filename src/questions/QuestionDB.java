		...
		try {
			...
			while (resultSet.next()) {
				...
				Question question = new Question(resultSet.getInt("id"), resultSet.getString("question"),
						resultSet.getInt("difficulty"), answers, resultSet.getInt("solution"), category);
				return question;
			}
	...
	public void update(Question q) {
		...
		if (this.getConnection() != null) {
			...
			try {
				...
				String query = "UPDATE questions SET " + "question = ?, " + "difficulty = ?, " + "answer_id = ?, "
						+ "solution = ?, " + "category_id = ? " + "WHERE id = ?";
