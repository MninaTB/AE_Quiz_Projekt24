...
public class QuestionDBTest {
	...
	public void testGetByID() throws SQLException {
		...
		String query = "SELECT questions.*, answers.a, answers.b, answers.c, answers.d, categories.name"
				+ " FROM questions" + " LEFT JOIN answers ON questions.answer_id = answers.id"
				+ " LEFT JOIN categories ON questions.category_id = categories.id" + " WHERE questions.id = ?";
	...
	public void testGetByDifficulty() throws SQLException {
		...
		String query = "SELECT questions.*, answers.a, answers.b, answers.c, answers.d, categories.name"
				+ " FROM questions" + " LEFT JOIN answers ON questions.answer_id = answers.id"
				+ " LEFT JOIN categories ON questions.category_id = categories.id" + " WHERE questions.difficulty = ?";
		...
		Mockito.when(resultSetMock.getString("answers.d")).thenReturn("Test 4");
		Mockito.when(resultSetMock.getString("categories.name")).thenReturn("Test Category");
		Mockito.when(resultSetMock.next()).thenReturn(false).thenReturn(true).thenReturn(true).thenReturn(false)
	...
	public void testGetByCategory() throws SQLException {
		...
		String query = "SELECT questions.*, answers.a, answers.b, answers.c, answers.d, categories.name"
				+ " FROM questions" + " LEFT JOIN answers ON questions.answer_id = answers.id"
				+ " LEFT JOIN categories ON questions.category_id = categories.id" + " WHERE questions.category_id = ?";
		...
		Mockito.when(resultSetMock.getString("answers.c")).thenReturn("Test 3");
		Mockito.when(resultSetMock.getString("answers.d")).thenReturn("Test 4");
		Mockito.when(resultSetMock.next()).thenReturn(false).thenReturn(false).thenReturn(true).thenReturn(false)
				.thenReturn(true).thenReturn(false).thenReturn(true).thenReturn(false).thenReturn(true).thenReturn(true)
				.thenReturn(false);
		Mockito.when(resultSetMock.getInt("id")).thenReturn(1).thenReturn(1).thenReturn(1).thenReturn(1).thenReturn(4);
		Mockito.when(resultSetMock.getString("question")).thenReturn("Test Frage");
		Mockito.when(resultSetMock.getInt("difficulty")).thenReturn(2);
		Mockito.when(resultSetMock.getInt("solution")).thenReturn(3);
	...
	public void testGetAllQuestions() throws SQLException {
		...
		Mockito.when(resultSetMock.getString("answers.d")).thenReturn("Test 4");
		Mockito.when(resultSetMock.getString("categories.name")).thenReturn("Test Category");
		Mockito.when(resultSetMock.next()).thenReturn(false).thenReturn(true).thenReturn(true).thenReturn(true)
				.thenReturn(false);
		Mockito.when(resultSetMock.getInt("id")).thenReturn(1);
		Mockito.when(resultSetMock.getString("question")).thenReturn("Test Frage");
		Mockito.when(resultSetMock.getInt("difficulty")).thenReturn(2);
